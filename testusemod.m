...
BLOK=13;
% % load(['E:/BCI_IIdata/data/M_X_train_all_block_new_',num2str(BLOK),'.mat'])
% % load(['E:/BCI_IIdata/data/M_y_train_all_block_new_',num2str(BLOK),'.mat'])
% % load(['E:/BCI_IIdata/data/M_z_train_all_block_new_',num2str(BLOK),'.mat'])
% % 
...
plot(M_sce(:,1))
% plot(aa_1)
plot(-M_sce0(:,1)+M_sce(:,1),'-p')
drawnow
legend('非增强训练集','增强训练集','加权值')
